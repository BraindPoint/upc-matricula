...
public class dialogBuscarMatricula extends javax.swing.JDialog {
    ...
    public dialogBuscarMatricula() {
        ...
        try {
            ...
            for (int i = 0; i < LP.size(); i++) {
                cboidMatricula.addItem(LP.get(i).getCodigo());
            }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            ...
            if (matricula != null) {
                //Datos del alumno
                txtidAlumno.setText(matricula.getAlumno().getCodigo());
                ...
                txtidHorario.setText(matricula.getProgramacion().getHorario().getCodigo());
                ...
                txtCodigoAlumno.setText(matricula.getProgramacion().getAula().getCodigo());
