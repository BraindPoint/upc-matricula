...
public class dialogProfesor extends javax.swing.JDialog {
    ...
    void textos(boolean tf) {
        txtCodigoProfesor.setEnabled(tf);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtCodigoProfesor, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(121, 121, 121)
                        .addComponent(jLabel4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtDni, javax.swing.GroupLayout.DEFAULT_SIZE, 84, Short.MAX_VALUE))
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        textos(true);
        controles(false);
        txtCodigoProfesor.requestFocus();
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        String idProfespor;
        limpiarTextos();
        idProfespor = JOptionPane.showInputDialog("Ingresar codigo del profesor a eliminar: ");
        Profesor profesor;
        try {
            profesor = ProfesorCN.getInstancia().buscarProfesor(idProfespor);
            if (profesor != null) {
                txtCodigoProfesor.setText(profesor.getCodigo());
                ...
                JOptionPane.showMessageDialog(this, "Codigo del profeso no registrado");
            }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        // TODO add your handling code here:
        String idProfesor;
        idProfesor = JOptionPane.showInputDialog("Ingrese Codigo del profeosor a modificar: ");
        Profesor profesor;
        try {
            ...
            if (profesor != null) {
                ...
                JOptionPane.showMessageDialog(this, "El Codigo profesor no existe");
            }
        } catch (SQLException e) {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        // TODO add your handling code here:
        if (txtCodigoProfesor.getText().equals("")) {
        ...
        idProfesor = txtCodigoProfesor.getText();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        // TODO add your handling code here:
        String idProfesor;
        idProfesor = JOptionPane.showInputDialog("Ingresar Codigo profesor a buscar: ");
        Profesor profesor;
        try {
            profesor = ProfesorCN.getInstancia().buscarProfesor(idProfesor);
            if (profesor != null) {
                ...
                JOptionPane.showMessageDialog(this, "El Codigo profesor no registrado");
            }
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(this, e.getMessage());
        }
